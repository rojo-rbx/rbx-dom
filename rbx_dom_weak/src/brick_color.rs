...
impl BrickColor {
    ...
    pub fn from_palette(value: u8) -> Option<BrickColor> {
        match value {
            ...
            2 => Some(BrickColor::BrightBluishGreen),
            3 => Some(BrickColor::Black),
            4 => Some(BrickColor::DeepBlue),
            5 => Some(BrickColor::DarkBlue),
            6 => Some(BrickColor::NavyBlue),
            7 => Some(BrickColor::ParsleyGreen),
            8 => Some(BrickColor::DarkGreen),
            9 => Some(BrickColor::Teal),
            10 => Some(BrickColor::SmokyGrey),
            11 => Some(BrickColor::SteelBlue),
            12 => Some(BrickColor::StormBlue),
            13 => Some(BrickColor::Lapis),
            14 => Some(BrickColor::DarkIndigo),
            15 => Some(BrickColor::Camo),
            16 => Some(BrickColor::SeaGreen),
            17 => Some(BrickColor::Shamrock),
            18 => Some(BrickColor::Toothpaste),
            19 => Some(BrickColor::SandBlue),
            20 => Some(BrickColor::MediumBlue),
            21 => Some(BrickColor::BrightBlue),
            22 => Some(BrickColor::ReallyBlue),
            23 => Some(BrickColor::Mulberry),
            24 => Some(BrickColor::ForestGreen),
            25 => Some(BrickColor::BrightGreen),
            26 => Some(BrickColor::Grime),
            27 => Some(BrickColor::LimeGreen),
            28 => Some(BrickColor::PastelBlueGreen),
            29 => Some(BrickColor::Fossil),
            30 => Some(BrickColor::ElectricBlue),
            31 => Some(BrickColor::Lavender),
            32 => Some(BrickColor::RoyalPurple),
            33 => Some(BrickColor::Eggplant),
            34 => Some(BrickColor::SandGreen),
            35 => Some(BrickColor::Moss),
            36 => Some(BrickColor::Artichoke),
            37 => Some(BrickColor::SageGreen),
            38 => Some(BrickColor::PastelLightBlue),
            39 => Some(BrickColor::CadetBlue),
            40 => Some(BrickColor::Cyan),
            41 => Some(BrickColor::Alder),
            42 => Some(BrickColor::Lilac),
            43 => Some(BrickColor::Plum),
            44 => Some(BrickColor::BrightViolet),
            45 => Some(BrickColor::Olive),
            46 => Some(BrickColor::BrYellowishGreen),
            47 => Some(BrickColor::Olivine),
            48 => Some(BrickColor::LaurelGreen),
            49 => Some(BrickColor::QuillGrey),
            50 => Some(BrickColor::GhostGrey),
            51 => Some(BrickColor::PastelBlue),
            52 => Some(BrickColor::PastelViolet),
            53 => Some(BrickColor::Pink),
            54 => Some(BrickColor::HotPink),
            55 => Some(BrickColor::Magenta),
            56 => Some(BrickColor::Crimson),
            57 => Some(BrickColor::DeepOrange),
            58 => Some(BrickColor::NewYeller),
            59 => Some(BrickColor::MediumGreen),
            60 => Some(BrickColor::Mint),
            61 => Some(BrickColor::PastelGreen),
            62 => Some(BrickColor::LightStoneGrey),
            63 => Some(BrickColor::LightBlue),
            64 => Some(BrickColor::BabyBlue),
            65 => Some(BrickColor::CarnationPink),
            66 => Some(BrickColor::Persimmon),
            67 => Some(BrickColor::ReallyRed),
            68 => Some(BrickColor::BrightRed),
            69 => Some(BrickColor::Maroon),
            70 => Some(BrickColor::Gold),
            71 => Some(BrickColor::BrightYellow),
            72 => Some(BrickColor::DaisyOrange),
            73 => Some(BrickColor::CoolYellow),
            74 => Some(BrickColor::PastelYellow),
            75 => Some(BrickColor::Pearl),
            76 => Some(BrickColor::Fog),
            77 => Some(BrickColor::Mauve),
            78 => Some(BrickColor::Sunrise),
            79 => Some(BrickColor::TerraCotta),
            80 => Some(BrickColor::DustyRose),
            81 => Some(BrickColor::Cocoa),
            82 => Some(BrickColor::NeonOrange),
            83 => Some(BrickColor::BrightOrange),
            84 => Some(BrickColor::Wheat),
            85 => Some(BrickColor::Buttermilk),
            86 => Some(BrickColor::InstitutionalWhite),
            87 => Some(BrickColor::White),
            88 => Some(BrickColor::LightReddishViolet),
            89 => Some(BrickColor::PastelOrange),
            90 => Some(BrickColor::Salmon),
            91 => Some(BrickColor::Tawny),
            92 => Some(BrickColor::Rust),
            93 => Some(BrickColor::CGABrown),
            94 => Some(BrickColor::BrYellowishOrange),
            95 => Some(BrickColor::Cashmere),
            96 => Some(BrickColor::Khaki),
            97 => Some(BrickColor::LilyWhite),
            98 => Some(BrickColor::Seashell),
            99 => Some(BrickColor::PastelBrown),
            100 => Some(BrickColor::LightOrange),
            101 => Some(BrickColor::MediumRed),
            102 => Some(BrickColor::Burgundy),
            103 => Some(BrickColor::ReddishBrown),
            104 => Some(BrickColor::Cork),
            105 => Some(BrickColor::Burlap),
            106 => Some(BrickColor::Beige),
            107 => Some(BrickColor::Oyster),
            108 => Some(BrickColor::MidGray),
            109 => Some(BrickColor::BrickYellow),
            110 => Some(BrickColor::Nougat),
            111 => Some(BrickColor::Brown),
            112 => Some(BrickColor::PineCone),
            113 => Some(BrickColor::FawnBrown),
            114 => Some(BrickColor::SandRed),
            115 => Some(BrickColor::HurricaneGrey),
            116 => Some(BrickColor::CloudyGrey),
            117 => Some(BrickColor::Linen),
            118 => Some(BrickColor::Copper),
            119 => Some(BrickColor::DarkOrange),
            120 => Some(BrickColor::DirtBrown),
            121 => Some(BrickColor::Bronze),
            122 => Some(BrickColor::DarkStoneGrey),
            123 => Some(BrickColor::MediumStoneGrey),
            124 => Some(BrickColor::Flint),
            125 => Some(BrickColor::DarkTaupe),
            126 => Some(BrickColor::BurntSienna),
            127 => Some(BrickColor::ReallyBlack),
...
mod tests {
    ...
    #[allow(deprecated)]
    fn from_palette() {
        assert_eq!(BrickColor::from_palette(99), Some(BrickColor::PastelBrown));
    }
    ...
    #[test]
    fn test_round_trip() {
        let value = BrickColor::PastelBrown;

        let serialized = serde_json::to_string(&value).unwrap();
        assert_eq!(serialized, "1030");

        let deserialized: BrickColor = serde_json::from_str(&serialized).unwrap();
