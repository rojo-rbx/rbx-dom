...
declare_rbx_types! {
    BinaryString => self::binary_string::BinaryStringType,
    Bool => self::bool::BoolType,
    CFrame => self::cframe::CFrameType,
    Color3 => self::colors::Color3Type,
    Color3uint8 => self::colors::Color3uint8Type,
    Content => self::content::ContentType,
    Enum => self::enumeration::EnumType,
    Float32 => self::numbers::Float32Type,
    Float64 => self::numbers::Float64Type,
    Int32 => self::numbers::Int32Type,
    Int64 => self::numbers::Int64Type,
    PhysicalProperties => self::physical_properties::PhysicalPropertiesType,
    Ref => self::referent::RefType,
    String => self::strings::StringType,
    UDim => self::udims::UDimType,
    UDim2 => self::udims::UDim2Type,
    Vector2 => self::vectors::Vector2Type,
    Vector2int16 => self::vectors::Vector2int16Type,
    Vector3 => self::vectors::Vector3Type,
    Vector3int16 => self::vectors::Vector3int16Type
}