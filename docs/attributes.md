...
This type is accepted by Roblox Studio. Though will almost never be generated by it, with the exception of the default number-type value being created explicitly through the Studio Properties Menu.
